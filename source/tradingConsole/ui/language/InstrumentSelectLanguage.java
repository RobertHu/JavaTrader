...
public class InstrumentSelectLanguage
{
  public static String Sequence = "";
  public static String IsSelected = "Select";
  ...
  public static void setValue(XmlNode xmlNode)
  {
    ...
    for (int i = 0; i < xmlNodeList.get_Count(); i++)
    {
      ...
      {
	InstrumentSelectLanguage.IsSelected = nodeValue;
      }
      else if (nodeName.equals("Description"))
      {
	InstrumentSelectLanguage.Description = nodeValue;
      }
    }
  }
